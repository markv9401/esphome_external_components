...
class GatePro : public endstop::EndstopCover, public PollingComponent, public uart::UARTDevice {
 public:
  void setup() override;
 ...
 protected:
  ...
  binary_sensor::BinarySensor *open_endstop_ = new BinarySensor();
  binary_sensor::BinarySensor *close_endstop_ = new BinarySensor();
